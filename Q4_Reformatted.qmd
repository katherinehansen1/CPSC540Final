...
In this DAG, we visualize and explore the relationships between the variables Effect, ConditionsSky, FlightPhase, OriginState, and Damage. FlightPhase is the exposure variable and the other variables are all confounders.
